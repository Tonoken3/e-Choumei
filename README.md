...
- 季節で島の色が変わり(春の若草→秋の黄金→冬は雪のブロックと氷の海)、APが減ると島が夕暮れて、雨や雪が降り、勇者の頭上に迷言の吹き出しが浮かびます。LLMが考えている間は「…」の思考バブルが出ます。
- 木は幹と葉のキューブ、岩は積み石、家は切妻屋根のコテージ、勇者はミニフィグ。すべてコードで手続き生成しており、画像アセットはありません。
