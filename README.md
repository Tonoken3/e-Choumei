...
観戦者は、ドラクエの「**さくせん**」やF1のチーム監督の指示のように、仙人に**作戦（standing order）を授ける**ことができます。一度授けた作戦は、変えるまで毎日引き継がれ続けます（途中で勝手に消えません）。観測情報の先頭に `strategy_from_heaven` として届き、仙人はそれを毎ターン重く受け止めます。
